...
<!-- 									</span> -->
									<c:choose>
										<c:when test="${summoner.tierTr != null}">
											<img src="${pageContext.request.contextPath}/assets/images/tier/${summoner.tierTr}.png" style="width: 3.5rem; border-radius: 0.95rem; margin-right: 0.5rem;"/>
											${summoner.tierTr} ${summoner.rankTr}
										</c:when>
										<c:otherwise>
											Unranked
										</c:otherwise>
				...
				<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
					...
					<!--begin::Nav item-->
					<li class="nav-item mt-2">
						<a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo19/dist/pages/user-profile/followers.html">소환사 게시판</a>
					</li>
					<!--end::Nav item-->
					<!--begin::Nav item-->
					<li class="nav-item mt-2">
